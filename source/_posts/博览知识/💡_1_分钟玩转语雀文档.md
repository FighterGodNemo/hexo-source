...
通过左上角加号面板![](💡_1_分钟玩转语雀文档/1654053059031-57d2d572-9c25-4134-adab-0cf30083cb81.png)，内容输入区斜杠面板`/`<font style="background-color:rgba(0, 0, 0, 0);">，可以找到所有语雀的特色卡片。</font>

+ 通过粘贴链接、@提及人或内容，`/语雀内容`，可以构建基于文档的知识网络

## 一、常用内容
![顶部工具栏](💡_1_分钟玩转语雀文档/1653483142501-7a33d47e-08b9-4cf4-a6dc-11c845f3d90a.png)
...
<font style="background-color:rgba(0, 0, 0, 0);">你可以在左上角的加号面板</font>![](💡_1_分钟玩转语雀文档/1654050989346-b7c21a9c-5cfe-4f82-9045-c152db021afb.png)<font style="background-color:rgba(0, 0, 0, 0);"> 和内容输入区的斜杠面板</font>`<font style="background-color:rgba(0, 0, 0, 0);">/</font>`<font style="background-color:rgba(0, 0, 0, 0);">中找到和插入所有语雀的特色卡片，详情见</font>

[插入特色卡片](https://www.yuque.com/yuque/gpvawt/fq1pad)

| ![加号面板](💡_1_分钟玩转语雀文档/1653483231485-abd5e86b-a7fd-4d8c-8ac5-31825af21805.png) | ![斜杠面板，通过/和cmd/唤起](💡_1_分钟玩转语雀文档/1654055064085-6f2d480d-7d62-4ef7-929a-90953432c095.png) |
| --- | --- |
...
![画板](💡_1_分钟玩转语雀文档/1643261198014-1b94d73a-8d53-416b-bc0e-05c2b61793ea.jpeg)

快速绘制简洁优雅的流程图，支持快速设置样式和排列。

![画板](💡_1_分钟玩转语雀文档/1615777131960-5c187699-2aff-4132-a4bb-61aaa8d837ae.jpeg)
...
[我要怎么开始用语雀.pdf](💡_1_分钟玩转语雀文档/1757165840011-e4adabf4-e2ba-4711-ba69-c72bc9ec5e56.pdf)
...
![](💡_1_分钟玩转语雀文档/1654063624693-193ba400-7ada-4452-a458-325f2a1db6a9.png)

![](💡_1_分钟玩转语雀文档/1654063639358-125a80c9-f128-49f4-9190-a3dff9fe185b.png)

# 🖊 小记
小记是语雀中碎片化内容记录工具，它可以帮你快速记录所思所想、收藏网页、整理待办，支持标签分类与归档。用小记收集的灵感，还可以合并成文档，成为结构化知识沉淀。

![](💡_1_分钟玩转语雀文档/1669017507929-643f953a-77bd-4115-80fc-f42436d93d58.png)
...
![](💡_1_分钟玩转语雀文档/1654132656119-446343b2-043e-46f9-bab6-97b04809cc22.png)
