...
>
> 1. 分析计算机检材，操作系统版本号为
![](2026%20FIC初赛/file-20260802223832474.png)

这里有个问题，题目问操作系统版本号，但是正确答案在火眼里是在系统版本号栏目的。
不能轻信火眼。由上图知操作系统叫deepin：
![](2026%20FIC初赛/file-20260802223832479.png)
因此确定是23.1
usr/lib/os-release
...
我来我也会被钓。太诱人了免费token。
![](2026%20FIC初赛/file-20260802223832487.png)
...
![](2026%20FIC初赛/file-20260802223832452.png)
...
![](2026%20FIC初赛/file-20260802223832430.png)![](2026%20FIC初赛/file-20260802223832439.png)  已确认
...
![](2026%20FIC初赛/file-20260802223832416.png)记住，按题号序号对应答案！

## 服务器

服务器仿真

![646](2026%20FIC初赛/file-20260802223832447.png)
注意！Vmware必须管理员权限打开！不然没权限仿真![](2026%20FIC初赛/file-20260802223832456.png)
![](2026%20FIC初赛/file-20260802223832460.png)
...
![](2026%20FIC初赛/file-20260802223832443.png)

## 二进制
先挂载U盘：
![](2026%20FIC初赛/file-20260802223832493.png)
![](2026%20FIC初赛/file-20260802223832497.png)
![](2026%20FIC初赛/file-20260802223832469.png)
### 1.分析u盘检材，找到其中保存的加密程序SampleVC.exe，请给出这个exe程序的md5值（答案格式：c4ca4238a0b923820dcc509a6f75849b）
![](2026%20FIC初赛/file-20260802223832465.png)
答案：764789dd9c095d74b6b258cf0f7568b2

2.分析SampleVC.exe，该程序编译的日期可能是什么？（答案格式：2025-06-06）
![](2026%20FIC初赛/file-20260802223832483.png)
答案：2026-04-17
...
分析main函数，这里是WinMain
![](2026%20FIC初赛/file-20260802223832502.png)
```
...
```
其中，最重要的一句话是：
![](2026%20FIC初赛/file-20260802223832507.png)
...
```
**线索 1：按钮创建时**
![](2026%20FIC初赛/file-20260802223832512.png)
(HMENU) 在创建子窗口控件时**就是控件的 ID**。这里写死了 0x2711。
**线索 2：按钮点击后**
Windows 消息机制：点按钮 → 系统发 WM_COMMAND 给父窗口。WM_COMMAND 的消息号是 0x111。
看 case 0x111u 这个分支：
![](2026%20FIC初赛/file-20260802223832516.png)
...
![](2026%20FIC初赛/file-20260802223832521.png)
