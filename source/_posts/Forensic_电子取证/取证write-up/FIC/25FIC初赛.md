...
<font style="color:#000000;">全局搜索</font>![](../../Forensic知识/取证write-up/file-20260318094803961.png)

`<font style="color:#000000;background-color:rgb(245, 245, 245);">检材2.tar/adb/lspd/log/props.txt</font>`<font style="color:#000000;"> 可以看到设备信息：</font>![](../../Forensic知识/取证write-up/file-20260318094803958.png)

<font style="color:rgb(82, 196, 26);">Redmi 6 Pro</font>

### <font style="color:#000000;">2.嫌疑人pc开机密码是什么？</font>
![](../../Forensic知识/取证write-up/file-20260318094803995.png)<font style="color:rgba(0, 0, 0, 0.87);">一般手机中记录密码的地方: 远控相关软件记录、手机便签、照片等。浏览该软件安装软件列表, 没有远程连接相关软件. 查看便签相关软件, 该设备安装了三个软件:</font>![](../../Forensic知识/取证write-up/file-20260318094803950.png)![](../../Forensic知识/取证write-up/file-20260318094803947.png)![](../../Forensic知识/取证write-up/file-20260318094803944.png)
...
![](../../Forensic知识/取证write-up/file-20260318094803940.png)自适应所有列![](../../Forensic知识/取证write-up/file-20260318094803936.png)
...
![](../../Forensic知识/取证write-up/file-20260318094803929.png)
...
![](../../Forensic知识/取证write-up/file-20260318094803933.png)

注意！这里直接看可能不完整。要打开后看，如下：

![](../../Forensic知识/取证write-up/file-20260318094803926.png)
...
![](../../Forensic知识/取证write-up/file-20260318094803915.png)
...
![](../../Forensic知识/取证write-up/file-20260318094803918.png)
...
![](../../Forensic知识/取证write-up/file-20260318094803899.png)

<u><font style="color:rgba(0, 0, 0, 0.87);">1864810197</font></u>

### <font style="color:#000000;">8.嫌疑人微信聊天记录数据库的加密秘钥是什么？</font>
知道uin了，用ForensicTool![](../../Forensic知识/取证write-up/file-20260318094803911.png)



### <font style="color:#000000;">9.请分析检材二，请分析"手机"检材，并回答，嫌疑人“欠条.rar”的解压密码是多少？</font>
![](../../Forensic知识/取证write-up/file-20260318094803903.png)

<font style="color:#000000;">推断手机号码藏在图片里  
</font>![](../../Forensic知识/取证write-up/file-20260318094803907.png)
...
![](../../Forensic知识/取证write-up/file-20260318094803991.png)

果然可以找到一个二维码

![](../../Forensic知识/取证write-up/file-20260318094803987.png)

如图，得到陈某的电话13170010703，也是欠条的密码：3170010703

（也能这样子做）

![](../../Forensic知识/取证write-up/file-20260318094803965.png)
...
![](../../Forensic知识/取证write-up/file-20260318094803984.png)



### <font style="color:#000000;">11.嫌疑人提供的“欠条.rar”解压后，其中"1.png"图上显示的VeraCrypt容器密码是多少？</font>![](../../Forensic知识/取证write-up/file-20260318094803922.png)
![](../../Forensic知识/取证write-up/file-20260318094803980.png)

可以看到屏幕当中有一串字符，应该是相关的密码，其实我觉得挺清楚的，但是也可以对比度加强点啥的

![](../../Forensic知识/取证write-up/file-20260318094803976.jpeg)

![](../../Forensic知识/取证write-up/file-20260318094803969.jpeg)
...
![](../../Forensic知识/取证write-up/file-20260318094803972.png)

所以李某可知为李安弘，陈某为陈浩北（可以解下边的题目）

其实这道题不用解出欠条也能知道（）

![](../../Forensic知识/取证write-up/file-20260318094803954.png)
