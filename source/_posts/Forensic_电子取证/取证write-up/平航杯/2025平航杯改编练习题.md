...
#### ![](file-20260403220318970.png)
cancro

### 2.倩倩的妈妈可能是哪里人(格式:北京人)
![](file-20260403220318991.png)

上海人

### 3.起早王对倩倩的手机进行了监控,倩倩在什么时候发现不对劲并上网搜索(格式:2020-01-01 01:01:01)
![](file-20260403220319073.png)2025-04-10 15:17:12

### 4.倩倩的出生日期是什么(格式：2000-01-01)
在剪切板处发现身份证号310104200108110624![](file-20260403220318915.png)

2001-08-11

### 5.手机内Puzzle_Game拼图程序拼图APK的SHA256值是多少(格式:123456789abcdef······)
![](file-20260403220319041.png)

直接右键计算结果是大写的。如果格式小写可以：

![](file-20260403220319009.png)
...
雷电APP智能分析——jadx反编译查看源码，搜fakeflag（类/方法/代码什么的全勾）![](file-20260403220319029.png)![](file-20260403220319068.png)会发现fakeflag是由一个方法赋值的，单击方法查看定义，会发现这个方法return的内容中，有一个常值变量。推断这个即为答案。![](file-20260403220319050.png)

D0you_f1nd_truth?

### 7.手机内Puzzle_Game拼图程序拼图APK中的Flag1是什么(格式:I_l0ve_SPC)
接上题，会发现fakeflag所在的类里面还有另一个flag函数。仔细看AESUtil.descryptFlag：![](file-20260403220319083.png)

跳转：

![](file-20260403220319019.png)
...
![](file-20260403220319112.png)

Key_1n_the_P1c

### 8.倩倩周末几点起床(格式：25:00)
#### ![](file-20260403220318964.png)
9:00

### 9.检材内除了微信和QQ，还有一款加固过的聊天交友软件，请问安装包名是什么(com.tencent.mm)
聊天软件且加固过

![](file-20260403220319092.png)
...
听书锁定番茄免费小说com.dragon.read![](file-20260403220319161.png)

找到所在文件夹，发现f内容最多，不妨从这里切入

![](file-20260403220319229.png)

![](file-20260403220319180.png)

看cdn_image_cache缓存![](file-20260403220319191.png)
...
![](file-20260403220319001.png)

2025-04-10 11:15:29

### 15.起早王用户SID的末四位是什么（格式:1234）
![](file-20260403220319171.png)

1001

### 16.起早王计算机连接的蓝牙设备的Guid是什么(格式：{abcdefg-123456})
![](file-20260403220319211.png)

{e0cbf06c-cd8b-4647-bb8a-263b43f0f974}

### 17.起早王的便签的第4条是什么(格式：我要学电子取证)
#### ![](file-20260403220319200.png)
或仿真看

![](file-20260403220319220.png)
...
![](file-20260403220319240.png)

![](file-20260403220319249.png)![](file-20260403220319258.png)
...
![](file-20260403220319275.png)

14

### 20.SillyTavern中账户起早王的密码是什么(格式：abcdefg123456)
![](file-20260403220319303.png)

线索藏在10号的笔记里

![](file-20260403220319266.png)

qzwqzw114

### 21.SillyTavern中虚拟角色Akari有几个标签(格式：1)
搜索sillyTavern，这里我有个习惯技巧，就是把everything.exe复制进虚拟机，瞬间搜索：![](file-20260403220319312.png)

相比之下文件管理器搜索太慢了

![](file-20260403220319283.png)

仔细浏览文件夹中的文件，发现似乎没有启动文件，于是再向上一层，无。

再向上一层，发现start.bat后，双击，等待一段时间，按Enter，成功进入浏览器

![](file-20260403220319341.png)

![](file-20260403220319294.png)

![](file-20260403220319331.png)

选择角色

![](file-20260403220319321.png)

6

### 22.起早王一共在电脑中存储了几种语言模型(格式:1)
![](file-20260403220319434.png)![](file-20260403220319452.png)

5

### 23.电脑中E盘bitlocker的密码是什么(格式：114514)
![](file-20260403220319351.png)

20240503LOVE

### 24.电脑中ai换脸界面的运行模式是什么(格式：abc)
![](file-20260403220319378.png)

facefusion想必与换脸有关![](file-20260403220319369.png)

cuda

### 25.第三张被换脸的图片所使用的换脸模型是什么(带文件后缀)(格式：xxxxxxxxxxx.xxxx)
![](file-20260403220319387.png)![](file-20260403220319406.png)
...
![](file-20260403220319425.png)

直接用WPS打开就行。不需要下载xmind

![](file-20260403220319397.png)

secretqianqian

### 27.neo4j数据库版本是多少(格式：1.1.1)
![](file-20260403220319416.png)

3.5.14

### 28.起早王的虚拟货币钱包的助记词的第1个是什么(格式：abandon)
![](file-20260403220319444.png)

![](file-20260403220319506.png)![](file-20260403220319461.png)![](file-20260403220319470.png)

![](file-20260403220319488.png)
...
1.在命令行输入**neo4j.bat console**![](file-20260403220319479.png)
...
密码：secretqianqian![](file-20260403220319516.png)

![](file-20260403220319550.png)

g.ltd@elcvxzfy.pro

![](file-20260403220319526.png)

万一数据很多找不到，可以直接Ctrl+F搜索

![](file-20260403220319536.png)13267438847

### 30.起早王的虚拟货币钱包地址是什么(格式：0x11111111)
![](file-20260403220319558.png)

熟悉的以太坊钱包MetaMask

![](file-20260403220319563.png)![](file-20260403220319541.png)

28题的助记词发现可以重置密码

flash treat wide divide type plug garlic draft infant broom desert useful

![](file-20260403220319568.png)
...
[区块链浏览器查询 | 欧科云链 OKLink](https://www.oklink.com/zh-hans)![](file-20260403220319573.png)

Sepolia网络

0xd8786a1345cA969C792d9328f8594981066482e9![](file-20260403220319578.png)现在看没了。很奇怪

正常来说是这样的

![](file-20260403220318975.png)

其实还有一个看的地方

![](file-20260403220319597.png)

[https://sepolia.etherscan.io/](https://sepolia.etherscan.io/)

别问为什么登不上，问就是就是网络问题

![](file-20260403220319583.png)
...
![](file-20260403220319592.png)![](file-20260403220319588.png)
