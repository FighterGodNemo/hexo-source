...
![](../../file-20260331130228782.png)

回顾：

![](../../file-20260331130228799.png)
...
![](../../file-20260331130228718.png)

放入010editor查看

![](../../file-20260331130228727.png)

很规律的一大块。发现其中Filter前面暗藏玄机。故Ctrl+F搜索Filter，在**Variables**变量表中获取flag

![](../../file-20260331130228737.png)
...
![](../../file-20260331130228790.png)

只开启了栈不可执行，应该是栈溢出题目。

使用ROPgadget

![](../../file-20260331130228771.png)

找到了sh地址：0x08048670 

直接写死：sh_addr = 0x08048670

![](../../file-20260331130228763.png)
...
![](../../file-20260331130228709.png)

默认值：

![](../../file-20260331130228691.png)
...
重新用ida32打开magic.exe，进入`内核选项 kernel options`，**取消勾选** `进行"无返回"分析 perform no-return analysis`，这样分析`main` 函数内容会更完整。  ![](../../file-20260331130228673.png)
...
![](../../file-20260331130228597.png)

获得大量文件。寻找核心的Midpython.pyc，使用**pycdc**

![](../../file-20260331130228623.png)

![](../../file-20260331130228615.png)
...
![](../../file-20260331130228701.png)

将密码.txt放入010 editor

![](../../file-20260331130228665.png)

![](../../file-20260331130228632.png)

> wllm_is_the_best_team!
>

解压得到：![](../../file-20260331130228648.png)

网上搜索跳舞的小人解码图：

![](../../file-20260331130228656.jpeg)
...
### [BJDCTF 2020]鸡你太美  
#### #编码分析 #脚本编写 #GIF提取
![](../../file-20260331130228606.png)

这个gif文件没有正确显示。文件头修复：

![](../../file-20260331130228580.png)
...
![](../../file-20260331130228589.png)

Ctrl+U查看源代码

![](../../file-20260331130228562.png)

**GFXEIM3YFZYGQ4A=**显然是线索。

全大写+等号，推测是base32编码。放入CyberChef解码。

![](../../file-20260331130228536.png)
...
![](../../file-20260331130228545.png)

查看发现是jpeg格式。修改后缀：

![](../../file-20260331130228528.png)
...
![](../../file-20260331130228553.png)

把另外两个图片复制出来保存。

![](../../file-20260331130228509.png)

![](../../file-20260331130228491.png) 
...
![](../../file-20260331130228500.png)

EXECUTE

![](../../file-20260331130228518.png)
...
![](../../file-20260331130228464.png)flag{W0w_y0u_c4n_rea11y_enc0d1ng!}
...
![](../../file-20260331130228481.png)

2. Decode.exe -X cipher.mp3

![](../../file-20260331130228472.png)
...
### ![](../../file-20260331130228447.png)
### [SWPUCTF 2021 新生赛]Do_you_know_http
#### #HTTP协议  #信息收集 #PHP
![](../../file-20260331130228429.png)
...
![](../../file-20260331130228438.png)

NSSCTF{Admin123!@#}

### [NISACTF 2022]huaji？
#### #图片隐写 #压缩包分析 #图片分离
![](../../file-20260331130228421.png)

binwalk提取文件：

一个加密zip内含flag

![](../../file-20260331130228396.png)

接下来找解压密码。原图片应该还有未发掘信息。

![](../../file-20260331130228412.png)

6374665f4e4953415f32303232

![](../../file-20260331130228387.png)

ctf_NISA_2022。解压

![](../../file-20260331130228404.png)
...
![](../../file-20260331130228378.png)

![](../../file-20260331130228370.png)

修改User Agent为WLLM，EXECUTE

![](../../file-20260331130228361.png)

先把URL改为a.php，再添加X-Forward-For为127.0.0.1

![](../../file-20260331130228351.png)
...
+ 解压出一个可爱的小草神.png![](../../file-20260331130228827.png)
+ 题目提示图片缺少下半部分，故使用[随波逐流]CTF编码工具修复高宽![](../../file-20260331130228817.png)
...
![](../../file-20260331130228334.jpeg)![](../../file-20260331130228324.jpeg)
...
#### #RCEPHP #信息收集
![](../../file-20260331130228263.png)

法一：打开网页看到一句话木马命令（想到中国蚁剑）

![](../../file-20260331130228242.png)

![](../../file-20260331130228233.png)

退到最外层，直接找到flag

![](../../file-20260331130228224.png)
...
![](../../file-20260331130228135.png)

`wllm=system('cat /flag');`

![](../../file-20260331130228145.png)
...
![](../../file-20260331130228125.png)

发送查看响应：

![](../../file-20260331130228116.png)

![](../../file-20260331130228108.png)

NSSCTF{71963bd4-678f-4d99-96d5-4c9fba40ad5e}

### [NSSRound#V Team]画出一个flag
#### #LSB #MISC #图片隐写
![](../../file-20260331130228213.png)

![](../../file-20260331130228195.png)

翻了一下，无特别的信息。

使用Stegsolve查看LSB

![](../../file-20260331130228163.png)
...
![](../../file-20260331130228204.png)

需要不断调整窗口比例和缩放比例，直至能辨认无误。看得那叫一个老眼昏花。

![](../../file-20260331130228154.png)
...
![](../../file-20260331130228090.png)

发现解密后开头不太对：

![](../../file-20260331130228015.png)

试着反转一下再解密

![](../../file-20260331130228099.png)
...
![](../../file-20260331130228063.png)

YzBibXZnaHl6X3swUmF6X2d4eG0wdGhrem9fMG9iMG1fdm9rY2N6dF8hcn0=

![](../../file-20260331130228072.png)

c0bmvghyz_{0Raz_gxxm0thkzo_0ob0m_vokcczt_!r}

根据题目：凯撒21位

![](../../file-20260331130228054.png)

h0gralmde_{0Wfe_lccr0ympet_0tg0r_atphhey_!w}

最后栅栏密码解密：

![](../../file-20260331130228036.png)

hgame{Welc0me_t0_the_w0rld_0f_crypt0graphy!}

###  [第五空间 2021]WebFTP
#### #目录扫描 #信息收集 #.git泄露
![](../../file-20260331130228045.png)

使用御剑工具扫描，发现大量域名

![](../../file-20260331130227997.png)

![](../../file-20260331130228026.png)![](../../file-20260331130228006.png)
...
![](../../file-20260331130227988.png)

![](../../file-20260331130227970.png)
...
![](../../file-20260331130227960.png)

Ctrl+U查看源代码也可

![](../../file-20260331130227941.png)
...
![](../../file-20260331130227858.png)

![](../../file-20260331130227868.png)拿到题目首先upx脱壳。再ida32分析：

![](../../file-20260331130227877.png)

![](../../file-20260331130227886.png)
