...
# <font style="color:#000000;">五题积累之（一）</font>
## <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">1.Crypto</font>
### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">[鹤城杯 2021]easy_crypto</font>
#### #古典密码 #词频分析
...
![](五题积累/1765115310800-7dcefdcd-43c6-4e7d-9899-cf41c4da218d.png)

<font style="color:rgb(82, 196, 26);">flag{IlUqU9O5guX6YiITsRNPiQmbhNRjGuTP}</font>

## <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">2.Web</font>
### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">[鹤城杯 2021]流量分析</font>
#### #流量分析 #日志审计 #脚本编写
<font style="color:#000000;">抢分做法：一把梭</font>

![](五题积累/1765115640138-caab3a53-8554-408f-9732-487e82927ed4.png)

<font style="color:#000000;">回顾：</font>

![](五题积累/1765329116986-562a5daf-f554-4d74-94f8-9cb4cee4fa3e.png)

<font style="color:#000000;">1. 发现大量HTTP请求包含SQL盲注特征</font>

<font style="color:#000000;">2. 攻击者使用ASCII逐字符提取技术，通过判断每个位置字符的ASCII值来获取flag</font>

<font style="color:#000000;">3. 这种技术是典型的基于响应的SQL盲注攻击</font>

<font style="color:#000000;">攻击者通过盲注技术获取了存储在数据库表 t 中的flag字段内容。</font>

<font style="color:rgb(82, 196, 26);">flag{w1reshARK_ez_1sntit}</font>

## <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">3.Misc</font>
###  [NSSRound#12 Basic]坏东西 
#### #PDF隐写#压缩包分析
先尝试用文件名解压，发现确实是解压密码。

![](五题积累/1765454300954-98c6132f-d76b-48b2-81f4-01290d757ee5.png)
...
![](五题积累/1765456020212-3f7ec032-766d-4625-8a26-eacd08c9e675.png)

放入010editor查看

![](五题积累/1765456405327-5d27fe06-e755-4e19-bf7b-46875b5b6506.png)

很规律的一大块。发现其中Filter前面暗藏玄机。故Ctrl+F搜索Filter，在**Variables**变量表中获取flag

![](五题积累/1765456676074-1b766ec6-5d44-4b14-92d8-144f806a5fde.png)

<font style="color:rgb(82, 196, 26);">NSSCTF{25da50b7993c0db55867a5a51f32f35c}</font>

## <font style="color:#000000;">4.Pwn</font>
### <font style="color:#000000;"> [WUSTCTF 2020]getshell2</font> 
#### #栈溢出 #ret2syscall #栈
附件：service
...
![](五题积累/1765440886789-2fe11bd4-cbe3-4712-ae39-ff130e8ecb09.png)

只开启了栈不可执行，应该是栈溢出题目。

使用ROPgadget

![](五题积累/1765441676863-122b7814-85af-41ae-aeff-4ed99822f41a.png)

找到了sh地址：0x08048670 

直接写死：sh_addr = 0x08048670

![](五题积累/1765443910791-0facf499-2498-4312-bf48-12e384b67b04.png)
...
![](五题积累/1765444547530-cfd1ce9b-3375-4330-ad6c-945fd729b606.png)

+ `<font style="color:#000000;background-color:rgba(175, 184, 193, 0.2);">gets()</font>`<font style="color:#000000;">、</font>`<font style="color:#000000;background-color:rgba(175, 184, 193, 0.2);">strcpy()</font>`<font style="color:#000000;"> 等</font>属于没有边界检查的函数。

<font style="color:rgba(255, 255, 255, 0.85);background-color:rgb(21, 21, 21);">🛠️</font><font style="color:rgba(255, 255, 255, 0.85);background-color:rgb(21, 21, 21);"> 六、完整攻击流程</font>

1. **<font style="color:rgba(255, 255, 255, 0.85);background-color:rgb(21, 21, 21);">连接远程服务</font>**
2. **<font style="color:rgba(255, 255, 255, 0.85);background-color:rgb(21, 21, 21);">p = remote('ip', port)</font>**

**<font style="color:rgba(255, 255, 255, 0.85);background-color:rgb(21, 21, 21);">构造 payload</font>**

    - <font style="color:rgba(255, 255, 255, 0.85);background-color:rgb(21, 21, 21);">填充 28 字节到返回地址位置</font>
    - <font style="color:rgba(255, 255, 255, 0.85);background-color:rgb(21, 21, 21);">覆盖返回地址为</font><font style="color:rgba(255, 255, 255, 0.85);background-color:rgb(21, 21, 21);"> </font>`<font style="color:rgba(255, 255, 255, 0.85);background-color:rgba(175, 184, 193, 0.2);">system</font>`
    - <font style="color:rgba(255, 255, 255, 0.85);background-color:rgb(21, 21, 21);">提供 fake return 和</font><font style="color:rgba(255, 255, 255, 0.85);background-color:rgb(21, 21, 21);"> </font>`<font style="color:rgba(255, 255, 255, 0.85);background-color:rgba(175, 184, 193, 0.2);">"sh"</font>`<font style="color:rgba(255, 255, 255, 0.85);background-color:rgb(21, 21, 21);"> </font><font style="color:rgba(255, 255, 255, 0.85);background-color:rgb(21, 21, 21);">地址</font>
3. **<font style="color:rgba(255, 255, 255, 0.85);background-color:rgb(21, 21, 21);">发送 payload</font>**
...
4. **<font style="color:rgba(255, 255, 255, 0.85);background-color:rgb(21, 21, 21);">进入交互模式，输入命令</font>**
...
<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">Q1: 为什么不用 </font>`<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">"/bin/sh"</font>`<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">，而用 </font>`<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">"sh"</font>`<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">？</font>

<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">很多题目为了简化，只放了</font><font style="color:#000000;background-color:rgba(255, 255, 255, 0);"> </font>`<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">"sh"</font>`<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">。</font>

<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">在 Linux 中，</font>`<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">system("sh")</font>`<font style="color:#000000;background-color:rgba(255, 255, 255, 0);"> </font><font style="color:#000000;background-color:rgba(255, 255, 255, 0);">和</font><font style="color:#000000;background-color:rgba(255, 255, 255, 0);"> </font>`<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">system("/bin/sh")</font>`<font style="color:#000000;background-color:rgba(255, 255, 255, 0);"> </font><font style="color:#000000;background-color:rgba(255, 255, 255, 0);">效果几乎一样，都能弹 shell。</font>

<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">Q2:</font><font style="color:#000000;background-color:rgba(255, 255, 255, 0);"> </font>`<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">0xdeadbeef</font>`<font style="color:#000000;background-color:rgba(255, 255, 255, 0);"> </font><font style="color:#000000;background-color:rgba(255, 255, 255, 0);">是什么？会 crash 吗？</font>

<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">它只是一个“占位符”，表示“随便填个地址”。</font>

<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">只要你在</font><font style="color:#000000;background-color:rgba(255, 255, 255, 0);"> </font>`<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">system</font>`<font style="color:#000000;background-color:rgba(255, 255, 255, 0);"> </font><font style="color:#000000;background-color:rgba(255, 255, 255, 0);">返回前已经拿到 shell，程序是否 crash 都不影响你读 flag。</font>

<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">Q3: 为什么偏移是 28（0x18+4）？</font>

`<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">0x18 = 24</font>`<font style="color:#000000;background-color:rgba(255, 255, 255, 0);"> </font><font style="color:#000000;background-color:rgba(255, 255, 255, 0);">字节是 buffer 大小</font>

`<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">+4</font>`<font style="color:#000000;background-color:rgba(255, 255, 255, 0);"> </font><font style="color:#000000;background-color:rgba(255, 255, 255, 0);">是 saved ebp（旧的栈基址指针）</font>

<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">总共 28 字节后，才是返回地址</font>

## <font style="color:#000000;">5.Reverse</font>
### <font style="color:#000000;"> [SEETF 2022]Magic </font>
#### <font style="color:#000000;">#反调试 #REVERSE</font>
题目描述：There might be a hidden gate to the magical land of flags...

![](五题积累/1765458244445-1a2dcc74-e14f-4138-9292-7dd0fadc898f.png)

默认值：

![](五题积累/1765459836846-7885b01f-310e-4148-9171-da2adc2d82a0.png)
...
重新用ida32打开magic.exe，进入`内核选项 kernel options`，**取消勾选** `进行"无返回"分析 perform no-return analysis`，这样分析`main` 函数内容会更完整。  ![](五题积累/1765460243786-00ab2b1f-bb12-404b-b5fb-cb04a2b87bf4.png)
...
# 五题积累之（二）
## <font style="color:#000000;">1.MISC</font>
### 
## <font style="color:#000000;">2.Reverse</font>
### <font style="color:#000000;">[MoeCTF 2021]midpython</font>
#### #Python #自定义逻辑 #REVERSE
![](五题积累/1765613876855-fd4f1e0a-716f-41fe-9066-03cdaa5a24d2.png)
...
![](五题积累/1765614632157-56b956db-65f2-4812-9097-2cc908b75388.png)

获得大量文件。寻找核心的Midpython.pyc，使用**pycdc**

![](五题积累/1765615408681-9a3f0ad9-f5e3-4ddb-889a-356bc0dcebed.png)

![](五题积累/1765616056912-ef29f59d-2020-47b9-8622-03e7e58cede3.png)
...
<font style="color:rgb(82, 196, 26);">moectf{Pyth0n_M@st3r!!}</font>

## 3.Crypto
### <font style="color:#000000;"> [SWPU 2019]伟大的侦探</font>
#### #跳舞的小人 #编码分析 #编码转换
 附件压缩包里一个txt文本，一个加密文件夹

![](五题积累/1765593996177-1606f4fa-06eb-4980-8bcb-16a55a967396.png)

将密码.txt放入010 editor

![](五题积累/1765612459600-c1ab88d2-8a5c-4e51-bf28-3a5a01efac9a.png)

![](五题积累/1765612489525-08e7abbc-065c-4c86-93df-84e7463c8758.png)

> wllm_is_the_best_team!
>

解压得到：![](五题积累/1765612729463-968e811b-8303-47bc-9e32-73d5ab24730d.png)

网上搜索跳舞的小人解码图：

![](五题积累/1765612859706-97a9c10c-979a-441d-9c4b-f0cc81c24618.jpeg)

<font style="color:rgb(82, 196, 26);">flag{iloveholmesandwllm}</font>
...
## <font style="color:#000000;">Misc</font>
### <font style="color:#000000;">[BJDCTF 2020]鸡你太美  </font>
#### <font style="color:#000000;">#编码分析 #脚本编写 #GIF提取</font>
![](五题积累/1765640495300-f0d0e6c6-2d49-42d7-98eb-d1685d89dd9b.png)

这个gif文件没有正确显示。文件头修复：

![](五题积累/1765640539509-fdfb097b-6f07-44ba-9993-91e8387e35fb.png)

<font style="color:rgb(82, 196, 26);">NSSCTF{zhi-yin-you-are-beautiful}</font>

## <font style="color:#000000;">Misc</font>
### <font style="color:#000000;"> [SWPUCTF 2021 新生赛]gif好像有点大 </font>
#### <font style="color:#000000;">#GIF #提取二维码 #图片隐写</font>
纯找。

![](五题积累/1765676998196-64adfdf2-032a-4916-b8d6-ba5519f8dc60.png)



## <font style="color:#000000;">Web</font>
### <font style="color:#000000;">[BJDCTF 2020]Ezphp</font>
#### <font style="color:#000000;">#数组绕过 #正则绕过 #弱比较 #PHP的类型转换 #伪协议 #extract函数的使用 #sha1碰撞</font>
环境：http://node4.anna.nssctf.cn:28905/

![](五题积累/1765677507702-6ee30e3a-78b8-4926-a77a-b81ebd3c69ec.png)

Ctrl+U查看源代码

![](五题积累/1765677564385-ca044cb3-2e6c-4132-afc1-727019db923b.png)

**GFXEIM3YFZYGQ4A=**显然是线索。

全大写+等号，推测是base32编码。放入CyberChef解码。

![](五题积累/1765677633410-1d3a6d4f-875b-47fd-b214-1926a338c309.png)
...
## <font style="color:#000000;">Misc</font>
### <font style="color:#000000;">[SDCTF 2022]Susan Album Party</font>
#### <font style="color:#000000;">#图片隐写 #图片分离 #结构隐写</font>
<font style="color:#000000;"> My friend Susan is having a photo album party, but she accidentally corrupted the SD card with all her photos on it! Can you save Susan's party by recovering her photos?</font>

<font style="color:#000000;">附件：stub</font>

![](五题积累/1765931165139-8f2e0139-6232-4e3a-a6bd-deaa24e3300b.png)

查看发现是jpeg格式。修改后缀：

![](五题积累/1765931214566-be2e332b-b1c2-4cba-b8b2-6fae512c9e6f.png)
...
![](五题积累/1765931756963-0f760b69-377f-4200-96a2-c9af027ac26e.png)

把另外两个图片复制出来保存。

![](五题积累/1765931994092-49731b13-a59e-4859-b7ab-852d343593ff.png)

![](五题积累/1765932010079-0ce779c6-c3fb-4678-842a-f2b82c2a0f0b.png) 

这里很坑，明明写得像SOME结果说是S0ME。看来该leet还得leet。        

<font style="color:rgb(82, 196, 26);">sdctf{FFD8_th3n_S0ME_s7uff_FFD9}</font>

## <font style="color:#000000;">Web</font>
### <font style="color:#000000;">[SWPUCTF 2021 新生赛]easy_md5</font>
#### <font style="color:#000000;">#弱比较 #PHP #数组绕过</font>
![](五题积累/1765934998485-b19703d4-d1b6-4282-853c-c6ff9f893539.png)
...
![](五题积累/1765933411479-71e5f353-5531-4a48-a731-dc27b0b8e3df.png)

EXECUTE

![](五题积累/1765933337557-9cc5a081-bdd2-49b4-88a2-f927c0d8f7cf.png)
...
![](五题积累/1766144164255-eb28a707-cdc4-4c53-b77d-092cc707f8b6.png)<font style="color:rgb(82, 196, 26);">flag{W0w_y0u_c4n_rea11y_enc0d1ng!}</font>

<font style="color:rgb(82, 196, 26);"></font>

### <font style="color:#000000;"> [西湖论剑 2022]mp3</font>
#### #Misc文件 #隐写音频 #隐写
1. <font style="color:rgb(51, 51, 51);">把需要分析的mp3文件拖到MP3stego所在目录</font>

![](五题积累/1766212603431-b22efd86-e5d8-4f4e-9360-1b48ab50cb07.png)

2. Decode.exe -X cipher.mp3

![](五题积累/1766212634204-5c1764fa-332e-4861-bb92-0fc3f207c7c4.png)
...
### ![](五题积累/1766230905845-d08e3dc3-fc02-4f8d-bb98-f7370812bbcb.png)
### <font style="color:#000000;">[SWPUCTF 2021 新生赛]Do_you_know_http</font>
#### <font style="color:#000000;">#HTTP协议  #信息收集 #PHP</font>
![](五题积累/1766235099139-ff270216-b53e-42e5-910a-554a9a1b5f41.png)



### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">[长城杯 2021 院校组]签到</font>
#### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">#编码分析 #字符编码ASCII</font>
> #### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">5a6d78685a3374585a57786a6232316c5833527658324e6f5957356e5932686c626d64695a544639</font>

<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">先hexadecimal再base64</font>

<font style="color:rgb(82, 196, 26);">flag{Welcome_to_changchengbe1}</font>

### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">[陇剑杯 2021]webshell（问1）</font>
#### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">#流量分析 #Webshell #流量日志审计</font>
<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">单位网站被黑客挂马，请您从流量中分析出webshell，进行回答：  
</font><font style="color:#000000;background-color:rgba(255, 255, 255, 0);">黑客登录系统使用的密码是_____________。</font>

![](五题积累/1766295987971-966e4f1d-6918-49de-99e0-782c38398408.png)

<font style="color:rgb(82, 196, 26);">NSSCTF{Admin123!@#}</font>

### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">[NISACTF 2022]huaji？</font>
#### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">#图片隐写 #压缩包分析 #图片分离</font>
![](五题积累/1766297321271-34516320-639b-4f54-ac88-754f894df022.png)

binwalk提取文件：

一个加密zip内含flag

![](五题积累/1766297404688-ebfd7cc8-1db4-4e4d-81a2-e862e2f18369.png)

接下来找解压密码。原图片应该还有未发掘信息。

![](五题积累/1766297775458-6c65550b-d253-492b-9d32-719999f95264.png)

6374665f4e4953415f32303232

![](五题积累/1766298355545-27b6f1cb-75e8-497b-8081-ba3b1c99380d.png)

ctf_NISA_2022。解压

![](五题积累/1766299769101-f47c6d57-9bb2-4109-a54d-d939343f5d1c.png)

<font style="color:rgb(82, 196, 26);">flag{Nls@_FumYEnnOjy}</font>

### <font style="color:#000000;">[SWPUCTF 2021 新生赛]Do_you_know_http</font>
#### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">#HTTP协议 #信息收集 #PHP</font>
<font style="color:#000000;">法一：Hackbar</font>

![](五题积累/1766300776747-574fa0e8-769c-4948-bc4c-6b59e1eaa0d3.png)

![](五题积累/1766300814706-36d4d971-3a62-4671-989b-f24461ad978a.png)

修改User Agent为WLLM，EXECUTE

![](五题积累/1766300886640-b020c29c-d19d-45da-b467-437d2d4aab7e.png)

先把URL改为a.php，再添加X-Forward-For为127.0.0.1

![](五题积累/1766301138810-59f93c79-1e87-4f37-ad81-c3a98136620f.png)

<font style="color:rgb(82, 196, 26);">NSSCTF{4732ec48-fa30-4e78-93c3-3fafe98452b8}</font>

### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">[BJDCTF 2020]base??</font>
#### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">#Base家族 #古典密码 #其他</font>
...
<font style="color:rgb(82, 196, 26);">BJD{D0_Y0u_kNoW_Th1s_b4se_map}</font>

### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">[LitCTF 2023]这羽毛球怎么只有一半啊（恼 (初级)</font>
#### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">#宽高修改 #图片隐写 #图片修复</font>
题目：所以下半身是什么呢（ww

+ 解压出一个可爱的小草神.png![](五题积累/1758346105799-9cc01e51-3120-4632-b6b1-69b1a025ce2d.png)
+ 题目提示图片缺少下半部分，故使用[随波逐流]CTF编码工具修复高宽![](五题积累/1758346226687-c5742520-e620-4796-8f7a-26b40d02fe36.png)

<font style="color:rgb(82, 196, 26);">LitCTF{Fl4g_0fcourse!}</font>

## <font style="color:#000000;">Crypto</font>
### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">[LitCTF 2023]Hex？Hex！(初级)</font>
#### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">#古典密码 #Base家族 #其他</font>
<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">题目描述: 如果你也和我一样知道hex的话，那我觉得，这件事，太酷啦！</font>

> <font style="color:#000000;">4c69744354467b746169313131636f6f6c6c616161217d</font>
>

十六进制转字符即可

![](五题积累/1766302790828-4db5dedf-26cd-4a31-9bbf-016c8dad54d9.png)

<font style="color:rgb(82, 196, 26);">LitCTF{tai111coollaaa!}</font>

<font style="color:#000000;background-color:rgba(255, 255, 255, 0);"></font>

## <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">Crypto</font>
### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">[SWPUCTF 2021 新生赛]traditional</font>
#### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">#古典密码 #其他</font>
> <font style="color:#000000;">题目：</font>
>
> <font style="color:#000000;">西方的二进制数学的发明者莱布尼茨，从中国的八卦图当中受到启发，演绎并推论出了数学矩</font>
>
> <font style="color:#000000;">阵，</font>
>
> <font style="color:#000000;">最后创造的二进制数学。二进制数学的诞生为计算机的发明奠定了理论基础。而计算机现在改</font>
>
> <font style="color:#000000;">变</font>
>
> <font style="color:#000000;">了我们整个世界，改变了我们生活，而他的源头却是来自于八卦图。现在，给你一组由八卦图</font>
>
> <font style="color:#000000;">方位</font>
>
> <font style="color:#000000;">组成的密文，你能破解出其中的含义吗？</font>
>
> <font style="color:#000000;"> 震坤艮 震艮震 坤巽坤 坤巽震 震巽兑 震艮震 震离艮 震离艮</font>
>
> <font style="color:#000000;"> 格式：NSSCTF{}</font>
>

![](五题积累/1766303310874-b60123e8-bb95-4724-a970-386752904ea1.jpeg)![](五题积累/1766303338709-41bbe71d-2942-4fda-b2de-497df8619660.jpeg)
...
<font style="color:rgb(82, 196, 26);">NSSCTF{Da01sall}</font>
...
<font style="color:rgb(82, 196, 26);">NSSCTF{4aea146e9dc7365e4ec931f547284822}</font>





### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">[羊城杯 2020]Simple</font>
#### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">#RSA #Crypto</font>
```python
...
### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">[SWPUCTF 2021 新生赛]include</font>
#### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">#PHP伪协议 #PHP #文件包含</font>
![](五题积累/1766478424703-f3e7f122-885b-400a-a2a7-7f22ff524089.png)![](五题积累/1766478513513-646e5c99-4d77-4ed9-9712-d7322b38e51b.png)

构造：?file=php://filter/read=convert.base64-encode/resource=flag.php

![](五题积累/1766478987184-7deee80f-16ef-4755-9bf8-390e9b10ea75.png)

<font style="color:rgb(0, 0, 0);">PD9waHANCiRmbGFnPSdOU1NDVEZ7OTdiYWY3MmUtMDg0ZS00MGIwLWFmYzEtMWE2NzAxOWFkODA2fSc7</font>

![](五题积累/1766479070298-99495b98-84da-4abe-b0ea-c2aec84341ea.png)

<font style="color:rgb(82, 196, 26);">NSSCTF{97baf72e-084e-40b0-afc1-1a67019ad806}</font>

## Reverse
### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">[SWPUCTF 2021 新生赛]非常简单的逻辑题</font>
#### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">#Python #语言逆向 #逆向技术</font>
```python
...
<font style="color:rgb(82, 196, 26);">NSSCTF{Fake_RERE_QAQ}</font>

### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">[SWPUCTF 2021 新生赛]caidao</font>
#### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">#RCEPHP #信息收集</font>
![](五题积累/1766489582096-271d528b-e5d6-459d-b889-8ff81999387c.png)<font style="color:rgb(255, 255, 255);background-color:rgb(29, 30, 31);"></font>

<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">法一：</font><font style="color:#000000;background-color:rgba(255, 255, 255, 0);">打开网页看到一句话木马命令（想到中国蚁剑）</font>

![](五题积累/1766490854625-2a13dd66-11d5-4225-b79e-c57b18fe87c6.png)

![](五题积累/1766490899063-b9ccb2fb-1774-436b-b000-7aa7257d0a83.png)

退到最外层，直接找到flag

![](五题积累/1766490983432-73335135-551e-4c61-b2d2-ae1b23c06734.png)

<font style="color:rgb(82, 196, 26);">NSSCTF{62487fd7-b969-4456-a318-f777ccbb1cc1}</font>

<font style="color:#000000;">法二：Hackbar，根据页面提示使用POST方式以wllm为参传值；  
</font><font style="color:#000000;">先传入system("ls /");查出根目录下有flag文件；在传入system("cat /flag");查看flag。</font>

`**<font style="color:#000000;">wllm=system("ls /");</font>**`

![](五题积累/1766578755244-cee54438-05a2-4497-9493-b268907a4384.png)

`wllm=system('cat /flag');`

![](五题积累/1766579964875-f5e639ac-1d24-4756-adfe-95b97f62c2f6.png)

<font style="color:rgb(82, 196, 26);">NSSCTF{71963bd4-678f-4d99-96d5-4c9fba40ad5e}</font>

法三：Burpsuite

Repeater把GET改为POST，右侧Inspector添加请求主体参数。

![](五题积累/1766583997466-4ecff68e-2d99-4258-9294-c62d14ed2389.png)

发送查看响应：

![](五题积累/1766584112315-d9709d47-42ef-40f6-9bd5-5cc952a5e8df.png)

![](五题积累/1766584190226-d2476b37-16f2-473d-8e9e-101283259b09.png)

<font style="color:rgb(82, 196, 26);">NSSCTF{71963bd4-678f-4d99-96d5-4c9fba40ad5e}</font>

### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">[NSSRound#V Team]画出一个flag</font>
#### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">#LSB #MISC #图片隐写</font>
![](五题积累/1766565158795-3fb11bed-5e39-4726-a26f-78c0de6a565e.png)

![](五题积累/1766565504608-efa9c361-06a5-415f-9440-0715d0680e43.png)

翻了一下，无特别的信息。

使用Stegsolve查看LSB

![](五题积累/1766565669447-7210af32-3832-4cdc-a877-70f59662254a.png)
...
![](五题积累/1766570725773-e0392faa-1e0a-4327-9cf1-a0b4e2f7de36.png)

需要不断调整窗口比例和缩放比例，直至能辨认无误。看得那叫一个老眼昏花。

![](五题积累/1766570974762-8af26d8a-765d-4011-b284-62ceea7e87de.png)

这样不错，最清楚了

<font style="color:rgb(82, 196, 26);">NSSCTF{!!Draw_draw_A_flag!!}</font>

### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">[HGAME 2022 week1]Matryoshka</font>
#### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">#维吉尼亚 #凯撒密码 #摩斯代码</font>
...
![](五题积累/1766849103286-2bdccb6c-3965-432c-8152-bc03450bba0b.png)

发现解密后开头不太对：

![](五题积累/1766849204459-da8984fc-826b-4ebc-9fc2-f313cfa4228d.png)

试着反转一下再解密

![](五题积累/1766849180960-13c16613-869f-49e4-ba9a-87f84dc9aada.png)
...
<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">16进制特征。</font>
...
> <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">466642756645466E6D4C73364433736959744C3658327034694E306364536C796B6D3972514E396F4D53316A6B7339724B3252366B4C38686F72303D</font>
>

![](五题积累/1766849699742-7403261c-9522-4a09-a81b-4b71c87e5b0b.png)

<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">FfBufEFnmLs6D3siYtL6X2p4iN0cdSlykm9rQN9oMS1jks9rK2R6kL8hor0=</font>

<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">然而直接base解码并不成功。</font>

<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">根据题目提示：维吉尼亚密码的key是hgame。不妨先试一下，因为解完末端依旧是=号，然后再base64可能性大一点。</font>

![](五题积累/1766850209567-6b765530-a8d5-4833-8be0-386c579b7680.png)

YzBibXZnaHl6X3swUmF6X2d4eG0wdGhrem9fMG9iMG1fdm9rY2N6dF8hcn0=

![](五题积累/1766850438102-7f66c79f-564a-482b-8a88-1f7ba2388296.png)

c0bmvghyz_{0Raz_gxxm0thkzo_0ob0m_vokcczt_!r}

根据题目：凯撒21位

![](五题积累/1766850582267-65c0652f-634e-4f75-97de-7852c120a062.png)

h0gralmde_{0Wfe_lccr0ympet_0tg0r_atphhey_!w}

最后栅栏密码解密：

![](五题积累/1766850654425-261e7e5f-2d61-41cd-856a-90b4dce1c8f8.png)

<font style="color:rgb(82, 196, 26);">hgame{Welc0me_t0_the_w0rld_0f_crypt0graphy!}</font>

### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);"> [第五空间 2021]WebFTP</font>
#### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">#目录扫描 #信息收集 #.git泄露</font>
![](五题积累/1767745276248-b6746f53-3b28-42c3-a6d9-1d5ef4b53615.png)

使用御剑工具扫描，发现大量域名

![](五题积累/1767748569564-eada15ec-175d-4880-8b69-316dabe208d9.png)

![](五题积累/1767748440402-03ef4531-aa69-4f1e-8bb3-528da9d42866.png)![](五题积累/1767748557557-f38dca24-d4da-44df-a2d3-5648441c3212.png)

NSSCTF{f632d0a0-0321-4df6-b3b7-fae9e4c0b269}



**<font style="color:rgba(0, 0, 0, 0.88);background-color:rgb(246, 249, 253);">Robots</font>**

<font style="color:rgba(0, 0, 0, 0.88);background-color:rgba(236, 241, 252, 0.38);">昨天十三年社团讲课，讲了Robots.txt的作用，小刚上课没有认真听课正在着急，你能不能帮帮忙</font>

![](五题积累/1767762576496-950173e6-071d-45e9-9adc-e6dbe2ee5c39.png)

![](五题积累/1767762615357-90435bc3-e0c1-453f-a34e-985d734963f2.png)

<font style="color:rgb(0, 0, 0);">flag{29d2b23a9f2145888d1f8c76e2b4a8b4}</font>

<font style="color:rgb(0, 0, 0);"></font>

<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">[SWPUCTF 2021 新生赛]easy_sql</font>
...
![](五题积累/1767764542937-040a1760-dbf5-4886-bd57-9e635d9cad26.png)
...
![](五题积累/1767764694451-e4f47383-23fa-4fcd-8e78-851e94cfbcd4.png)

Ctrl+U查看源代码也可

![](五题积累/1767764704939-eaace393-4a65-498d-8fe6-0f2ed4b2cdc1.png)
...
![](五题积累/1767764955290-7a3f5293-d000-451b-89c5-77e003127b6a.png)
...
![](五题积累/1767765268391-2f3c9e40-6aef-4600-8071-5ea120037c77.png)
...
![](五题积累/1767765898897-97356907-9390-4d8b-8921-d811770de7b8.png)
...
![](五题积累/1767766274055-742d91e9-29eb-4b74-8085-42eb51e20246.png)
...
![](五题积累/1767766312981-212ad42c-deb6-48fe-9b7a-6cfcf17af3e3.png)
...
![](五题积累/1767766344549-52a8d229-8982-4e85-9e37-965d4426b551.png)
...
### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">[BJDCTF 2020]encode</font>
#### <font style="color:#000000;background-color:rgba(255, 255, 255, 0);">#Base64 #RC4 #XOR</font>
**<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">附件：</font>**

![](五题积累/1771159433251-628d0bae-d9ec-4c3c-8ca1-9e4e7e5e42f9.png)

![](五题积累/1771159400192-96dad403-3b06-4ebd-9de4-48362b5fa342.png)<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">拿到题目首先upx脱壳。再ida32分析：</font>

![](五题积累/1771159928490-9384c871-e64f-47a5-946f-1d2c4b931f1d.png)

![](五题积累/1771159874044-ab36460c-5edb-4f2a-bf21-b4da92b3d06c.png)
