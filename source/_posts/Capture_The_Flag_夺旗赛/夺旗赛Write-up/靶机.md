...
updated: 2026-05-07T19:49
title: 靶机解题
permalink: '/2026/05/07/Capture_The_Flag_夺旗赛/夺旗赛Write-up/靶机/'
---
## Smoke
...
hosts类似**本地地址簿**，用来手动指定「域名 ↔ IP」的对应关系。
- 正常上网时，浏览器会去公网 DNS 服务器查 `smoke.dsz` 对应的 IP
- 但这个域名 `smoke.dsz` 是靶机本地用的，公网没有记录，所以必须在电脑里手动登记
```
echo "192.168.56.101 smoke.dsz" >> /etc/hosts
```
![](靶机/file-20260507194856476.png)
